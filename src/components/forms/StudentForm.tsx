...
const schema = z.object({
    ...
    password: z.string().min(0, { message: "Password must be at least 8 characters long!" }),
    ...
    return (
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <div className="flex justify-between flex-wrap gap-4">
                ...
                <InputField label="Email" name="email" defaultValue={data?.email} register={register} error={errors?.email} type="email" />
            ...
            <div className="flex justify-between flex-wrap gap-4">
                ...
                <div className="flex flex-col gap-2 w-full md:w-1/4 justify-center">
                    <label htmlFor="img" className="text-xs text-gray-500 flex items-center gap-2 cursor-pointer">
                        <Image alt="" src={"/icon/upload.png"} width={28} height={28}/>
